...
e);if(a[b]===d)return a.constructor.prototype[b].apply(a,e);throw Error("goog.base called from a method of one name to a method of a different name");};goog.scope=function(a){a.call(goog.global)};var BB={go:{}};"__BREAK_AWAY__";BB.Frame=function(a,b,c){this.win=a;this.scroll=b;this.mouse=c};BB.Session=function(a,b,c){this.fps=a||3;this.TICK=1E3*this.fps;this.title=b||BB.Session.getPageTitle();this.url=c||BB.Session.getPageUrl();this.frames=[];this.active=!1};BB.Session.prototype.start=function(){this.active||(this.active=!0,this.tick())};BB.Session.prototype.stop=function(){this.active=!1};BB.Session.prototype.tick=function(){};BB.Session.prototype.save=function(){};
BB.Session.prototype.upload=function(){};BB.Session.getPageTitle=function(){var a=document.getElementsByTagName("title"),b="Untitled document";0<a.length&&(b=a[0].textContent);return b};BB.Session.getPageUrl=function(){return window.location.href};
